{
    ...
    "cluster-grenade": "Асколачная граната",
    "coal": "Вугаль",
    "coin": "Грош",
    ...
    "discharge-defense-remote": "Электраразрадны абарончы камплект",
    ...
    "exoskeleton-equipment": {
        "equipment-name": "Экзашкілет",
        "technology-name": "Абсталяванне экзашкілета"
    },
    ...
    "flamethrower-damage": "Павялічэнне шкоды ад агнямёта",
    ...
    "grenade": "Граната",
    "grenade-damage": "Павялічэнне шкоды ад гранат",
    ...
    "item-request-proxy": "Пасрэднік для запытаў",
    "lab": "Лабараторыя",
    "land-mine": {
    ...
    "laser-turret-damage": "Павялічэнне шкоды ад лазерных турэлей",
    "laser-turret-speed": "Хуткасць стральбы лазерных турэлей",
    "laser-turrets": "Лазерныя турэлі",
    ...
    "research-speed": "Хуткасць лабараторый",
    "roboport": "Робапорт",
